    ...
    <form method="post" action="/payment-online" class="form card-body">
        ...
        <div class="form-row">
            ...
            {{--<div class="card content wrap-collabsible">--}}
                ...
                {{--<label for="collapsible0" class="lbl-toggle">Amazing weekend offer to keep the weekend exciting! Buy one, get one free</label>--}}
                {{--<div class="collapsible-content">--}}
                    {{--<div class="content-inner">--}}
                        {{--<section>--}}
                            {{--@foreach($weekend as $pack)--}}
                                {{--<div>--}}
                                    {{--<input type="radio" id="{{$pack->id}}" name="package" value="{{$pack->id}}" onchange="toggleChecked()">--}}
                                    {{--<label for="{{$pack->id}}">--}}
                                        {{--<h2>{{$pack->name}}</h2>--}}
                                        {{--<span>Extra {{$pack->name}} free!</span>--}}
            ...
            {{--<div class="card content wrap-collabsible">--}}
                {{--<input id="collapsible0" class="toggle" type="checkbox">--}}
                {{--<label for="collapsible0" class="lbl-toggle">Amazing Holiday Offer!</label>--}}
                {{--<div class="collapsible-content">--}}
                    {{--<div class="content-inner">--}}
                        {{--<section>--}}
                            {{--@foreach($holiday_packs as $pack)--}}
                                {{--<div>--}}
                                    {{--<input type="radio" id="{{$pack->id}}" name="package" value="{{$pack->id}}" onchange="toggleChecked()">--}}
                                    {{--<label for="{{$pack->id}}">--}}
                                        {{--<h2>{{$pack->name}}</h2>--}}
            ...
            {{--<div class="card content wrap-collabsible">--}}
                ...
                {{--<label for="collapsible" class="lbl-toggle">Night Bundle (8PM to Midnight)</label>--}}
                {{--<div class="collapsible-content">--}}
                    {{--<div class="content-inner">--}}
                        {{--<section>--}}
                            {{--@foreach($night_packs as $pack)--}}
                                {{--<div>--}}

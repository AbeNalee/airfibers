...
<div class="card-body">
    ...
    <form method="post" action="/payment" class="form card-body">
        ...
        <div class="form-group col-md-12 row mb-3 col-sm-7">
            <input type="hidden" name="phone" id="phone" class="form-control col-sm-4" value="{{auth()->user()->phone}}"/>
            <span>
                <p>Number of vouchers to buy:</p>
                <input type="text" id="total" name="total" value="1">
            </span>
        </div>
        <br>
